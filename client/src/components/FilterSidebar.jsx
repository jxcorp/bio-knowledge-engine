...
const FilterSidebar = ({ filters, onFilterChange, onSearchSubmit }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="pb-4 border-b border-gray-200">
                <h3 className="text-md font-semibold text-gray-800 mb-3 uppercase tracking-wider">Subject Categories</h3>
                <div className="space-y-2">
                    {CATEGORIES.map(category => (
                        <div key={category} className="flex items-center">
                            <input
                                ...
                                className="h-4 w-4 rounded text-blue-700 border-gray-300 focus:ring-blue-500"
                            />
                            <label htmlFor={`category-${category}`} className="ml-2 block text-sm text-gray-700 cursor-pointer">
                                {category}
                            </label>
                        </div>
                    ))}
            ...
            <div>
                <h3 className="text-md font-semibold text-gray-800 mb-3 uppercase tracking-wider">Publication Year</h3>
                <div className="flex justify-between space-x-3">
                    <div className="w-1/2">
                        <label htmlFor="year-start" className="block text-xs font-medium text-gray-500">From</label>
                        <input
                            id="year-start"
                            name="yearStart"
                            type="number"
                            ...
                            className="w-full p-2 border border-gray-300 rounded-md text-sm focus:ring-blue-500 focus:border-blue-500 mt-1"
                        />
                    </div>
                    <div className="w-1/2">
                        <label htmlFor="year-end" className="block text-xs font-medium text-gray-500">To</label>
                        <input
                            id="year-end"
                            name="yearEnd"
                            type="number"
